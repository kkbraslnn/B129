...
public class LinkedHashSet01 {
    ...
    public static void main(String[] args) {
        ...
        // 1000 tane tekrarlasanda Java en son gorunumunu size verir.  Override eder.
        // tekrarli eklenen "Set" e sadece bir kere koyar.
        artist.add("Tom");
        System.out.println(artist); // [Ajda, Tom, Brad, Angelina]  aslinda 2 tane Tom var
